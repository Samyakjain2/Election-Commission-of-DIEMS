		...
		<div class="card-body">
			...
			<colgroup>
				...
				<tbody>
					...
					$qry = $conn->query("SELECT *,concat(firstname,' ',lastname) as name FROM student_list order by concat(class_id) asc");
					while($row= $qry->fetch_assoc()):
					?>
					<tr>
						<th class="text-center"><?php echo $i++ ?></th>
						<td class="text-center"><b><?php echo $row['school_id'] ?></b></td>
						<td class="text-center"><b><?php echo $row['roll_no'] ?></b></td>
